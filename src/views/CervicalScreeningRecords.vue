    ...
    <div class="service-page">
      ...
      <div class="hs-toolbar">
        ...
        <div class="hs-toolbar-right">
          ...
          <button v-if="userRole === 'Admin'" class="hs-btn hs-btn-warning" @click="router.push('/maternalarchived')"><span class="mdi mdi-archive-outline"></span> Archived</button>
        ...
        <div class="hs-table-scroll">
          <table class="hs-table">
            ...
            <tbody>
              ...
              <tr v-if="filteredRecords.length === 0"><td colspan="9" class="hs-table-empty">No records found.</td></tr>
            </tbody>
          </table>
        </div>
