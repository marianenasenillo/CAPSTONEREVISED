        ...
        <div class="auth-form-card auth-form-card-wide">
          ...
          <div class="hs-form-row">
            <div class="hs-form-group">
              ...
              <input v-model="barangay" type="text" class="hs-input input-readonly" readonly />
          ...
          <div class="reg-button-row">
            <button class="hs-btn hs-btn-secondary hs-btn-lg reg-btn-cancel" @click="router.push('/bhw')">
              Back
            </button>
            <button class="hs-btn hs-btn-primary hs-btn-lg reg-btn-submit" :disabled="isLoading" @click="handleRegister">
...
<style scoped>
.auth-page { min-height: 100vh; background: linear-gradient(135deg, #f4f9ec 0%, var(--hs-gray-50) 40%, var(--hs-gray-50) 60%, #f4f9ec 100%); display: flex; align-items: center; justify-content: center; }
.auth-container { display: flex; min-height: 100vh; width: 100%; align-items: center; justify-content: center; }
.auth-form-panel {
...
.auth-form-header h2 { font-size: var(--hs-font-size-2xl); font-weight: 600; color: var(--hs-gray-900); margin-bottom: 4px; letter-spacing: -0.01em; }
.auth-form-header p { font-size: var(--hs-font-size-base); color: var(--hs-gray-500); }
...
@media (max-width: 1024px) { .auth-page { background: var(--hs-white); } .auth-form-panel { width: 100%; min-width: 0; min-height: 100vh; border-radius: 0; box-shadow: none; border-top: none; } }
